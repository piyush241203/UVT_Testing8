...
<div class="page-header">
  <h1>Contact</h1>
  <p class="subtitle">Experience the power of contact with our modern interface.</p>
</div>
<div class="card-container">
    ...
    <div class="card">
      ...
      <div style="display: flex; flex-direction: column; gap: 1rem; margin-top: 1rem;">
        <input type="text" placeholder="Name" style="padding: 0.75rem; border-radius: 0.5rem; border: none; background: #0f172a; color: white;" />
        <textarea placeholder="Message" style="padding: 0.75rem; border-radius: 0.5rem; border: none; background: #0f172a; color: white; min-height: 100px;"></textarea>
