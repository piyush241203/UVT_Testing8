...
<div class="page-header">
  <h1>Analytics</h1>
  <p class="subtitle">Experience the power of analytics with our modern interface.</p>
</div>
<div class="card-container">
  
    <div class="card"><h3>Page Views</h3><div class="stat">1.2M</div></div>
    <div class="card"><h3>Bounce Rate</h3><div class="stat">42%</div></div>
    <div class="card"><h3>Conversion</h3><div class="stat">3.8%</div></div>
