...
<div class="card-container">
    ...
    <div class="card"><h3>Profile Settings</h3><p>Update your personal information.</p><button class="btn">Edit Profile</button></div>
    <div class="card"><h3>Preferences</h3><p>Toggle dark mode, notifications, and more.</p><button class="btn">Manage</button></div>
