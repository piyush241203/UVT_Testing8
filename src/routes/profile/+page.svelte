...
<div class="page-header">
  <h1>Profile</h1>
  <p class="subtitle">Experience the power of profile with our modern interface.</p>
</div>
<div class="card-container">
  
    <div class="card" style="text-align: center;">
      <div style="width: 100px; height: 100px; border-radius: 50%; background: #38bdf8; margin: 0 auto 1rem;"></div>
      <h3>Alex Developer</h3>
      <p>Senior Engineer</p>
    </div>
    <div class="card"><h3>Bio</h3><p>Passionate about UI/UX and visual regression testing.</p></div>
