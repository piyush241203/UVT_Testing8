...
<div class="page-header">
  <h1>Products</h1>
  <p class="subtitle">Experience the power of products with our modern interface.</p>
</div>
<div class="card-container">
  
    <div class="card"><h3>Pro Plan</h3><div class="stat">$29/mo</div><p>Everything you need for testing.</p><button class="btn">Upgrade</button></div>
    <div class="card"><h3>Enterprise Plan</h3><div class="stat">Contact Us</div><p>Scale without limits.</p><button class="btn">Contact Sales</button></div>
...
<style>
  ...
  .btn { display: inline-block; padding: 0.75rem 1.5rem; background: #38bdf8; color: #0f172a; font-weight: bold; border-radius: 0.5rem; text-decoration: none; margin-top: 1rem; cursor: pointer; border: none; }
  .btn:hover { background: #7dd3fc; }
  .stat { font-size: 2.5rem; font-weight: bold; color: #818cf8; margin: 1rem 0; }
</style>
