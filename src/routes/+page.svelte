...
<div class="page-header">
  <h1>Home <span style="font-size: 1rem; background: #38bdf8; color: #0f172a; padding: 0.25rem 0.5rem; border-radius: 0.25rem; vertical-align: middle; margin-left: 1rem;">v1.0.0</span></h1>
