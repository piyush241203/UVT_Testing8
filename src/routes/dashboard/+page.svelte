...
<div class="card-container">
    ...
    <div class="card"><h3>Total Users</h3><div class="stat">24,592</div><p>+12% from last week</p></div>
    <div class="card"><h3>Revenue</h3><div class="stat">$45.2K</div><p>+5% from last week</p></div>
    <div class="card"><h3>Active Sessions</h3><div class="stat">1,204</div><p>Currently online</p></div>
